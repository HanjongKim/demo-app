package com.skb.demo.common.logger;
...
public class CommonLogger {
	...
	public void log(String msgId,String logType,String txId,String stbId,String extNm,String etcData){
		String mMsgId = msgId.isEmpty() || msgId == null? "NULL" : msgId;
		String mLogType = logType.isEmpty() || logType == null? "NULL" : logType;
		String mTxId = txId.isEmpty() || txId == null? "NULL" : txId;
		String mStbId = stbId.isEmpty() || stbId == null? "NULL" : stbId;
		String mExtNm = extNm.isEmpty() || extNm == null? "NULL" : extNm;
		String mEtcData = etcData.isEmpty() || etcData == null? "NULL" : etcData;
		
		logger.info(this.appName + "|" +
				mMsgId + "|" +
				mLogType + "|" +
				mTxId + "|" +
				mStbId + "|" +
